...
@EnabledIfV1
@Tag("migration")
@TestPropertySource(properties = "spring.flyway.target=1.42.0")
class TokenCreateFeeCollectorAssociationMigrationTest extends IntegrationTest  {
    ...
    @Value("classpath:db/migration/v1/V1.43.0__token_create_fee_collector_association.sql")
    ...
    @Test
    void verifyMigration() throws IOException {
        // given
        ...
        // dissociated himself with the new token. Note there won't be a associated=false token account record for
